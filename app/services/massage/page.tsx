  ...
  return (
    <div className="text-[#FFFBF2]">
      <div className="h-40 content-center bg-[url('/massage.png')] bg-cover bg-center bg-no-repeat object-cover text-center md:h-72">
        <h1 className="p-4 text-7xl italic drop-shadow-2xl">Massage</h1>
      </div>
      <div className="px-10 py-12 font-extralight xl:px-20">
        <div className="pb-7 text-xl xl:text-2xl">
          <div className="pb-5 text-justify leading-10">
          ...
          <div className="text-justify">
            ...
            <p className="pb-5">
              We specialise in Lava Tummy Massage. <br /> This short treatment
              is one of the most effective in relieving the discomfort of...
            </p>
            ...
            <p className="pb-5">
              This treatment involves the use of special hollow candles which
              are lit and inserted into the ear to create a gentle suction,
              sending tiny vibrations down the candle to gently manipulate the
              ear canal.{" "}
            </p>
            <p className="pb-5">
            ...
            <p className="pb-5">
              ...
              This is primarily a preventive form of medicine, unlike
              non-steroid anti-inflammatory drugs.
            </p>
            <p className="pb-5">
              Ear acupuncture is easily available for diagnosis and treatment.
              The auricular (ear) represents a micro map of the body.
            </p>
